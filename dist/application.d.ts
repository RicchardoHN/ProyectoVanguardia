...
declare const BackendDonacionsangreApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class BackendDonacionsangreApplication extends BackendDonacionsangreApplication_base {
